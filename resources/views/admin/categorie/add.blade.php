        ...
        <form class="edit-form" action="{{ url('/admin/category/add/save') }}" method="post"
            ...
            <div class="col-m-3 col12 m-2">
                <div class="card" style="width: 18rem;">
                    ...
                    <img class="card-img-top" src="{{ asset('img/logo_vide/add_image.PNG') }}" alt="Card image cap" id="preview2"
                        onclick="triggerFileInput();">

                      

                    <div class="card-body">
                        <input type="text" name="nom" class="form-control" placeholder="Titre de catégorie"></input>
                    </div>
