                    ...
                    <table id="example" class="table-striped table-bordered" style="width:100%">
                        ...
                        <tbody class="text-center">
                            @foreach ($listes as $liste)
                                <tr>
                                    <td class=" align-middle">{{ $liste->magasin1}}</td>
                                    <td class=" align-middle">{{ $liste->solde}} Dz</td>
                                    <td class=" align-middle">{{ $liste->magasin2}}</td>
                                        ...
                                        <div>
                                            ...
                                            <div class="col-1">
                                                ...
                                                <form class="show-form"
                                                    action="{{ url('/admin/transfert/' . $liste->id ) }}"
                                                    method="GET">
                                                    @csrf
