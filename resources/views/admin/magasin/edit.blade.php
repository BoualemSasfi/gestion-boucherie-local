    ...
    <div class="row animate__animated animate__backInLeft">
        ...
        <div class="card shadow col-12">
            ...
            <div class="card-body">
                ...
                <form class="edit-form" action="{{ url('/admin/magasin/'.$magasins->id.'/update') }}" method="post"
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <select id="" name="type" class="form-control">
                                    ...
                                    <option style="background-color: red;" value="{{$magasins->type}}">{{$magasins->type}}</option>
                     ...
                     <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12"
                            ...
                            @else
                                <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12" data-aos="flip-right">
                                    <iframe style="border:0; width: 100%; height: 350px;"
                                    src="{{ $magasins->loca }}" frameborder="0" allowfullscreen></iframe>
                                </div>
                            @endif
                            <!-- fin  -->
