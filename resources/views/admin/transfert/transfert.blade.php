        ...
        <div class="col-10 card card-body">
            ...
            <div class="tab-content">
                ...
                <!-- <div class="row">
                    ...
                    <label class="col-2 text-center">{{ $lemagasin->nom }}</label>
                    <label class="col-2 text-center">À ajouter</label>
                    <label class="col-2 text-center">{{ $magasins1->nom }}</label>
                </div> -->
                @foreach ($liste_cats as $index => $cat)
